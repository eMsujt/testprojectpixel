...
Index of the project's documentation. Start with **Architecture**.
...
See the [root README](../README.md) for a project overview, the feature-manager registry, and the command list.
