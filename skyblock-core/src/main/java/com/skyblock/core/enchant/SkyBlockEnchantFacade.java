 ...
 */
public final class SkyBlockEnchantFacade {

    private static final SkyBlockEnchantFacade INSTANCE = new SkyBlockEnchantFacade();

    private final EnchantManager enchantManager = EnchantManager.getInstance();

    private SkyBlockEnchantFacade() {}

    public static SkyBlockEnchantFacade getInstance() {
        return INSTANCE;
    }
