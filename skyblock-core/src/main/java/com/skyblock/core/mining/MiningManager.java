...
public final class MiningManager {
    ...
    private final Map<java.util.UUID, Double> miningXp = new HashMap<>();
    /** Per-player mining level cache. */
    private final Map<java.util.UUID, Integer> miningLevel = new HashMap<>();
     ...
     */
    public double addXp(java.util.UUID playerId, double amount) {
     ...
     */
    public double getXp(java.util.UUID playerId) {
        Objects.requireNonNull(playerId, "playerId");
     ...
     * @return mining level
     */
    public int getLevel(java.util.UUID playerId) {
        Objects.requireNonNull(playerId, "playerId");
     ...
     */
    public int getSpeedBonusForPlayer(java.util.UUID playerId) {
