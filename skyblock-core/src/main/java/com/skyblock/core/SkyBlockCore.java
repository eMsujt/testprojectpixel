...
public final class SkyBlockCore extends JavaPlugin {
    ...
    private HotmManager hotmPerkManager;
    ...
    private void initManagers() {
        ...
        hotmPerkManager = HotmManager.getInstance();
    ...
    public void onEnable() {
        ...
        getServer().getPluginManager().registerEvents(com.skyblock.core.listener.ForagingListener.getInstance(), this);
