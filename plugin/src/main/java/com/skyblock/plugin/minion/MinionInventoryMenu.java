 ...
 *
 * <p>A 27-slot (3-row) menu titled {@code §eMINION}, opened when a player
 * right-clicks their minion's storage. The interior holds the resources the
 * minion has gathered; the layout is framed by a {@code GRAY_STAINED_GLASS_PANE}
 * border with a close button on the bottom row.</p>
 */
