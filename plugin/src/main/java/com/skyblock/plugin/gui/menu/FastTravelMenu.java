 ...
 *
 * <p>A 54-slot (6-row) menu presenting one icon per warp destination, matching
 * Hypixel's Fast Travel layout. Clicking a destination icon tells the player
 * where they are warping; the actual teleport is performed by the warp command
 * handlers.</p>
 */
