...
public class TalismanBagMenu extends Menu {
    ...
    public TalismanBagMenu(Player player) {
        this(player, 0);
    }

    private TalismanBagMenu(Player player, int page) {
    ...
    protected void build() {
        ...
        setItem(49, new ItemBuilder(Material.GOLD_NUGGET)
        ...
        if (page > 0) {
            ...
            setItem(45, new ItemBuilder(Material.ARROW)
                    ...
                    .build(),
                    event -> new TalismanBagMenu(player, prevPage).open(player));
        }
        ...
        if ((page + 1) < totalPages) {
            ...
            setItem(53, new ItemBuilder(Material.ARROW)
                    ...
                    .build(),
                    event -> new TalismanBagMenu(player, nextPage).open(player));
        }
    }
