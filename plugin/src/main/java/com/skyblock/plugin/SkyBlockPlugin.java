...
public final class SkyBlockPlugin extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        getCommand("mayor").setExecutor(new MayorCommand(com.skyblock.core.mayor.MayorManager.getInstance()));
        ...
        getCommand("kuudra").setExecutor(new KuudraCommand(com.skyblock.core.kuudra.KuudraManager.getInstance()));
        ...
        getCommand("slayer").setExecutor(new SlayerCommand(com.skyblock.core.slayer.SlayerManager.getInstance()));
        getCommand("fishing").setExecutor(new FishingCommand(com.skyblock.core.fishing.FishingManager.getInstance(), com.skyblock.core.fishing.TrophyFishingManager.getInstance()));
        getCommand("collections").setExecutor(new CollectionsCommand(CollectionManager.getInstance()));
        getCommand("enchanting").setExecutor(new EnchantingCommand(com.skyblock.core.enchanting.EnchantingManager.getInstance()));
        getCommand("hotm").setExecutor(new HOTMCommand(com.skyblock.core.hotm.HOTMManager.getInstance()));
        getCommand("garden").setExecutor(new GardenCommand(com.skyblock.core.garden.GardenManager.getInstance()));
